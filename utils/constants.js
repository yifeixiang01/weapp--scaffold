...
//已使用的storageName
//loginInfo,包括token，phone,userId,signature,openId,expiredTime,wtId,dataKey
//user_id
//lastLocation

//每个page data中，会自动注入以下值,可以wxml中直接使用
// vehicleBackground: , // 背景颜色
// vehicleColor: , // 字体颜色
// colorStyle: // 模式
// isNotHaveNet  //是否没网
...
const appInfo = {
  ...
  appName: "TinnoveCinemaTicket", //app.js强依赖
  appChsName: "小程序通用组件demo",
  tabBarList:[   //各小程序tabBar页面要列入下面数组，因为要判断是用 switchTab还redirectTo跳转
    'pages/index/index',
    'pages/theater-list/theater-list',
    'pages/my/my',
  ],
  selectedCity: {
    name: ''
